  ...
  it 'calculates the square correctly with an input of 5', points: 3, hint: h('label_for_input params_are_strings') do
    ...
    begin
      ...
      expect(false).to be(true),
                       "Expected to find an <input> with an id attribute that matched the for attribute of a <label> but didn't find one."
    end
    number_input.set(5)
    find('button', text: /Calculate\s+square/i).click
...
describe '/square/new' do
  it 'calculates the square correctly with an input of 42.42', points: 3,
                                                               hint: h('label_for_input params_are_strings') do
    visit '/square/new'
...
describe '/square_root/new' do
  it 'calculates the square root correctly with an input of 5', points: 3,
                                                                hint: h('label_for_input params_are_strings') do
    visit '/square_root/new'
...
describe '/square_root/new' do
  it 'calculates the square root correctly with an input of 42.42', points: 3,
                                                                    hint: h('label_for_input params_are_strings') do
    visit '/square_root/new'
...
describe '/payment/new' do
  it 'correctly processes inputs when the form is submitted', points: 3,
                                                              hint: h('label_for_input params_are_strings') do
    visit '/payment/new'
    ...
    begin
      ...
      expect(false).to be(true),
                       "Expected to find an <input> with an id attribute that matched the for attribute of the APR <label> but didn't find one."
    end
    apr_input.set(3.24)
    ...
    begin
      ...
      expect(false).to be(true),
                       "Expected to find an <input> with an id attribute that matched the for attribute of the 'Number of years' <label> but didn't find one."
    end
    years_input.set(5)
...
describe '/random/new' do
  it 'leads to another functional RCAV when submitted', points: 6,
                                                        hint: h('button_type label_for_input copy_must_match') do
    visit '/random/new'
...
describe '/random/new' do
  it 'outputs a random number when the form is filled out and submitted', points: 10,
                                                                          hint: h('structure_must_match label_for_input copy_must_match') do
    random_numbers = []
    5.times do
      visit '/random/new'
      # fill_in "Minimum", with: 1.0
      ...
      numbers_on_page.each do |num|
        random_numbers.push(num) if num != 1 && num != 10
      end
    end
